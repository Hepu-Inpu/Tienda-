        ...
        <div class="container registro">
            <form  method="POST" action="RegistroControl?accion=insertar">
                <div class="row">
                    <div class="col-sm-6">
                        <label>Usuario</label>
                        <input type="text" class="form-control" name="nombres" placeholder="Ingrese Usuario" required>
                    </div>  
                    <div class="col-sm-6">
                        <label>Contacto</label>
                        <input type="number" class="form-control" name="contacto" placeholder="Ingrese contacto" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
