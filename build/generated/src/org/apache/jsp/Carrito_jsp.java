...
public final class Carrito_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </div>\n");
      out.write("<!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%          CARRITO             %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->\n");
      out.write("    <a class=\"navbar-brand h5\" href=\"ControladorCar?accion=Carr&menu=Carrito\"> \n");
      ...
      out.write("        </svg>\n");
      out.write("        <i class=\"fas fa-cart-plus\">(<label style=\"color: orange\">");
      ...
      out.write("\n");
      out.write("                </div>\n");
      out.write("                <div class=\"container col-sm-8 mt-4\">\n");
      out.write("                    <div class=\"row\">\n");
      out.write("                        <div class=\"table-responsive\">\n");
      out.write("                            <table class=\"table table-hover table table-bordered\">\n");
      out.write("                                <thead>\n");
      out.write("                                    <tr>\n");
      out.write("                                        <th>Producto</th>\n");
      out.write("                                        <th>Descripcion</th>\n");
      out.write("                                        <th>ID_CAT</th>\n");
      out.write("                                    </tr>\n");
      out.write("                                </thead>\n");
      out.write("                                ");

                                    List lista = new CarritoDAO().getAll();
                                    request.setAttribute("contador", lista.size());
                                    ListIterator list = lista.listIterator();
                                    while (list.hasNext()) {
                                        BeensProducto C = (BeensProducto) list.next();
      ...
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( C.getCosto());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( C.getDescrip());
      out.write("</td>\n");
